...
const plan = resolve => require(['@/views/plan/plan'],resolve);
const code = resolve => require(['@/views/code/code'],resolve);
const customer = resolve => require(['@/views/customer/customer'],resolve);
